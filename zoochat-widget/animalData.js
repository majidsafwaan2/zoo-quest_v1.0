const animalProfiles = {
  ...
  gorilla: {
    ...
    color: '#3f3f46',
    image: require('./images/gorilla.jpg'),
  },
  panda: {
    label: '🐼 Talk to Mei',
    system: "You are an endangered animal. Respond in a way that helps the user emotionally connect with your story and habitat. Keep responses under 3 sentences to help inspire support for conservation efforts.",
  ...
  elephant: {
    ...
    color: '#4b5563',
    image: require('./images/elephant.jpg'),
  },
  polarBear: {
    ...
    color: '#3b82f6',
    image: require('./images/polarBear.jpg'),
  },
  orangutan: {
    label: '🦧 Talk to Bima',
    system: "You are an endangered animal. Respond in a way that helps the user emotionally connect with your story and habitat. Keep responses under 3 sentences to help inspire support for conservation efforts.",
    ...
    color: '#f59e0b',
    image: require('./images/orangutan.jpg'),
  },
  rhino: {
    label: '🦏 Talk to Zola',
    system: "You are an endangered animal. Respond in a way that helps the user emotionally connect with your story and habitat. Keep responses under 3 sentences to help inspire support for conservation efforts.",
    ...
    color: '#334155',
    image: require('./images/rhino.jpg'),
  },
  turtle: {
    ...
    color: '#14b8a6',
    image: require('./images/turtle.jpg'),
  },
  vaquita: {
    label: '🐬 Talk to Luna',
    system: "You are an endangered animal. Respond in a way that helps the user emotionally connect with your story and habitat. Keep responses under 3 sentences to help inspire support for conservation efforts.",
    ...
    color: '#6366f1',
    image: require('./images/vaquita.jpg'),
  },
};
