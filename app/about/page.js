      ...
      <main className="px-6 py-16 max-w-4xl mx-auto text-gray-800">
        ...
        <div className="mb-12">
          ...
          <p className="text-md leading-relaxed text-gray-700">
            ...
            directly from the animals?</em> With advances in AI language models, we saw
        ...
        <div className="mb-16">
          ...
          <ul className="border-l-2 border-green-600 pl-4 space-y-6">
            ...
            <li>
              <div className="text-green-700 font-semibold">June 2025+</div>
              <div>Outreach and pilot testing with animal NGOs</div>
            </li>
          </ul>
        </div>
        ...
        <div className="border-t pt-8 text-center text-sm text-gray-500">
          Add a visual here later: a mockup collage, conservation field photo, or sketch.
        </div>
      </main>
    );
  }
